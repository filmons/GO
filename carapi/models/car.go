...
func NewCar(c *Car) {
    ...
    res, err := config.Db().Exec("INSERT INTO cars (manufacturer, design, style, doors, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?);", c.Manufacturer, c.Design, c.Style, c.Doors,c.CreatedAt, c.UpdatedAt)
